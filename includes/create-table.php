...
value VARCHAR(32) NOT NULL,
 UNIQUE KEY id (id) )DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;";
    ...
    $wpdb->query("INSERT INTO `$tableName` (`id`, `name`, `value`) VALUES (NULL, 'num2fa-post', '1'), (NULL, 'num2fa-post-title', '1'), (NULL, 'num2fa-post-meta', '0'), (NULL, 'num2fa-navbar', '1'), (NULL, 'num2fa-sidebar', '1'), (NULL, 'num2fa-enable', '0'), (NULL, 'num2fa-all', '0'), (NULL, 'convert-code', '0')");
}
